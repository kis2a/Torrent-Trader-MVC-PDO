...
<div class="sidebar close">
   <?php include "assets/themes/" . (Users::has('stylesheet') ?: Config::TT()['DEFAULTTHEME']) . "/navbar.php"; ?>
</div>

<section class="home-section">
  <div class="col"><br>
  <?php include "assets/themes/" . (Users::has('stylesheet') ?: Config::TT()['DEFAULTTHEME']) . "/navbar2.php"; ?>