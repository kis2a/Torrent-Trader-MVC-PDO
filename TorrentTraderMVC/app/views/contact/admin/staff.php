...
<table class='table table-striped table-bordered table-hover'><thead>
  ...
  <?php while ($arr = $data['res']->fetch(PDO::FETCH_ASSOC)) {
            if ($arr['answered']) {
                ...
                $answered = "<font color=green><b>Yes - <a href=".URLROOT."/users/read?id=$arr[answeredby]><b>" . Users::coloredname($arr3['username']) . "</b></a> (<a href=".URLROOT."/admincontactstaff/viewanswer?pmid=$arr[id]>View Answer</a>)</b></font>";
            } else {
