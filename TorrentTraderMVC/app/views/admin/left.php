...
<div class="border border-success">
    ...
    <li class="list-group-item"><a href="<?php echo URLROOT; ?>/adminfaq/manage"><img src="<?php echo URLROOT; ?>/assets/images/admin/faq.png" border="0" width="20" height="20" alt="" />&nbsp;<b><?php echo Lang::T("FAQ"); ?></b></a></li>
