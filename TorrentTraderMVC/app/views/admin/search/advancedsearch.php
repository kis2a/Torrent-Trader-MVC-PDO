...
// Validates date in the form [yy]yy-mm-dd;
		...
		u.class, u.uploaded, u.downloaded, u.donated, u.modcomment, u.enabled, u.warned, u.invited_by";
			...
			<tr><td align='right'><img src=\"".URLROOT."/assets/images/disable.png\" alt=\"Disabled\" /><input type='submit' name='disable' value=\"Disable Selected Accounts\" /></td><td style=\"border: none; padding: 2px;\" align='left'>&nbsp<input type='submit' name='enable' value=\"Enable Selected Accounts\" /> <img src=\"".URLROOT."/assets/images/disable.png\" alt=\"Disabled\" /> <i class='fa fa-check tticon' title='Ok'></i><</td></tr>
			<tr><td colspan='2'><br /></td></tr>
			<tr><td align='center'><img src=\"".URLROOT."/assets/images/warned.png\" alt=\"Warned\" /><input type='submit' name='warn' value=\"Warn Selected\" /></td><td><input type='submit' name='unwarn' value=\"Remove Warning Selected\" /> <img src=\"".URLROOT."/assets/images/warned.png\" alt=\"Warned\" /> <i class='fa fa-check tticon' title='Ok'></i><</td></tr>
