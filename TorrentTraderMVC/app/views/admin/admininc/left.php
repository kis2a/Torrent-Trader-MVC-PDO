...
<div class="border ttborder">
    ...
    <li class="list-group-item"><a href="<?php echo URLROOT; ?>/Adminsnatched"><img src="<?php echo URLROOT; ?>/assets/images/admin/hitnrun.png" border="0" width="20" height="20" alt="" />&nbsp;<b>Hit & Runs</b></a></li>
