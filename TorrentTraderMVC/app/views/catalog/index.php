...
print("<input type=submit value=" . Lang::T("SEARCH") . ">\n");
print("</form>\n");
print("<p><br />\n");
// Print Each Letter
for ($i = 97; $i < 123; ++$i) {
...
<div class="row"><?php
    ...
    foreach ($data['res'] as $arr) { ?>
        ...
        if (($arr["anon"] == "yes" || $cat["privacy"] == "strong") && $_SESSION["id"] != $arr["owner"] && $_SESSION["edit_torrents"] != "yes") {
...
//print("$s"); remember top peers/snatched
