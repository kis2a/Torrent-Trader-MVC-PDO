...
<html lang="en">
  <head>
    ...
    <!-- Bootstrap & core CSS -->
    <link href="<?php echo URLROOT; ?>/assets/themes/<?php echo (Auth::permission('stylesheet') ?: Config::TT()['DEFAULTTHEME']) ?>/bootstrap.min.css" rel="stylesheet">
    ...
    <link href="<?php echo URLROOT; ?>/assets/themes/<?php echo (Auth::permission('stylesheet') ?: Config::TT()['DEFAULTTHEME']) ?>/customstyle.css" rel="stylesheet">
