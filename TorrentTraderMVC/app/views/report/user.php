<b>Are you sure you would like to report user ?</b><br /><a href='<?php echo URLROOT; ?>/profile?id=<?php echo $data['user']; ?>'><b><?php echo User::coloredname($data['username']); ?></b></a><br />
