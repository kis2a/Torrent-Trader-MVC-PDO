...
a member of staff if you would like a new team creating</center><br>
 ...
 while ($row = $data['res']->fetch(PDO::FETCH_ASSOC)): ?>
      <div class="row frame-header">
           ...
           <div class="col-md-11">
                Owner: <?php echo ($row["username"]) ? '<a href="'.URLROOT.'/profile?id=' . $row["owner"] . '">' . Users::coloredname($row["username"]) . '</a>' : "Unknown User"; ?> - Added: <?php echo TimeDate::utc_to_tz($row["added"]); ?>
           </div>
      </div>
      <div class="row">
           <div class="col-md-1">
