...
a member of staff if you would like a new team creating</center><br>
 ...
 while ($row = $data['res']->fetch(PDO::FETCH_ASSOC)): ?>
       ...
       <thead><tr>
       <th></th>
       <th>Owner: <?php echo ($row["username"]) ? '<a href="'.URLROOT.'/profile?id=' . $row["owner"] . '">' . User::coloredname($row["username"]) . '</a>' : "Unknown User"; ?> - Added: <?php echo TimeDate::utc_to_tz($row["added"]); ?></th>
       </tr></thead>
       <tbody><tr>
