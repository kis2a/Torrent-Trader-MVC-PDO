...
<?php
print(($data["sender1"] ? "<a href=" . URLROOT . "/admincontactstaff/reply?receiver=" . $data["sender1"] . "&answeringto=$data[iidee]><b>Reply</b></a>" : "<font class=gray><b>Guest</b></font>") . " | <a href=" . URLROOT . "/admincontactstaff/deletestaffmessage?id=" . $data["id"] . "><b>Delete</b></a></td>");
?>
</td></tr></table>