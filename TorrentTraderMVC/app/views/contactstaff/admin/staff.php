...
while ($arr = $data['res']->fetch(PDO::FETCH_ASSOC)) {
    if ($arr['answered']) {
        ...
        $answered = "<font color=green><b>Yes - <a href=".URLROOT."/profile?id=$arr[answeredby]><b>" . User::coloredname($arr3['username']) . "</b></a> (<a href=".URLROOT."/admincontactstaff/viewanswer?pmid=$arr[id]>View Answer</a>)</b></font>";
    } else {
    ...
    <td><a href='<?php echo URLROOT; ?>/profile?id=$arr[sender]'><b><?php echo User::coloredname($arr['username']); ?></b></a></td>
