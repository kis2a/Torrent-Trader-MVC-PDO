...
class Bonus
{
    ...
    public function trade()
    {
		...
		INNER JOIN torrents ON snatched.tid = torrents.id
          ...
          <th class="table_head" width="1%"><i class='fa fa-upload tticon' title='Uploaded'></i></th>
          <th class="table_head" width="1%"><i class='fa fa-download tticon' title='Downloaded'></i></th>
