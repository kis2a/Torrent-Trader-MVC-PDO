...
class Group
{
    ...
    public function staff()
    {
        ...
        while ($row = $res->fetch(PDO::FETCH_ASSOC)) {
            ...
            "<td>
            <i class='fa fa-user' aria-hidden='true' style='" . ($row["last_access"] > $dt ? "color:white" : "color:red") . "' title='Profile'></i> " .
            "<a href='" . URLROOT . "/profile?id=" . $row["id"] . "'>" . Users::coloredname($row["username"]) . "</a> " .
                "<a href='" . URLROOT . "/messages/create?id=" . $row["id"] . "'><i class='fa fa-comment tticon' title='Send PM'></i></a></td>";
