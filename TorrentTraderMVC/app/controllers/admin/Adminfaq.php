...
class Adminfaq extends Controller
{
    ...
    public function manage()
    {
        ...
        Style::adminheader(Lang::T("FAQ_MANAGEMENT"));
        ...
        if (isset($faq_categ)) {
            ...
            $this->view('faq/admin/manage', $data);
        }
        Style::adminfooter();
    }
    ...
    public function reorder()
    {
            ...
            Redirect::to(URLROOT . "/adminfaq/manage");
    }
    ...
    public function delete()
    {
        if ($_GET['confirm'] == "yes") {
            ...
            print("<table border=\"0\" cellspacing=\"0\" cellpadding=\"5\" align=\"center\" width=\"95%\">\n<tr><td align=\"center\">Please click <a href=\"" . URLROOT . "/adminfaq/delete?id=$_GET[id]&amp;confirm=yes\">here</a> to confirm.</td></tr>\n</table>\n");
            Style::end();
            Style::adminfooter();
        }
    }
    ...
    public function newsection()
    {
        ...
        print("<form method=\"post\" action=\"" . URLROOT . "/adminfaq/newsection\">");
    ...
    //elseif ($_GET['action'] == "additem" && $_GET['inid']) {
        public function additem()
        {
            ...
            print("<form method='post' action='" . URLROOT . "/adminfaq/additem'>");
