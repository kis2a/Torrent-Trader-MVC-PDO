<?php
// Include 	cal_days_in_monthlasses
include(APPROOT."/libraries/tmdb/data/Movie.php");
include(APPROOT."/libraries/tmdb/data/TVShow.php");
include(APPROOT."/libraries/tmdb/data/Season.php");
include(APPROOT."/libraries/tmdb/data/Episode.php");
include(APPROOT."/libraries/tmdb/data/Person.php");
include(APPROOT."/libraries/tmdb/data/Role.php");
include(APPROOT."/libraries/tmdb/data/roles/MovieRole.php");
include(APPROOT."/libraries/tmdb/data/roles/TVShowRole.php");
include(APPROOT."/libraries/tmdb/data/Collection.php");
